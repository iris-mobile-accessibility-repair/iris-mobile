...
# APKName = "com.news.offac.apps"
# # APKName = 'jp.co.hateblo.bomberhead_lab.e_alcohol_calendar2'
...
# # HOME_PATH = "/home/zyx/decompile"
# HOME_PATH = '/home/zyx/Desktop/work0/apktool'
# APKName = "com.btmura.android.reddit_12"
...
def find_colorToChange(nonIssueColorAct, id_colorSet, componentClass, id, colorToChange_class):
    color_id = {}
...
def solveTextContrast(decom_Path, id, txt, colorToChange, colorName_colorNew, id_style, nonIssueColorAct, id_bound_colorSet, colorToChange_class):
    # print id
        ...
        if drawableNames != [] and text_color != '':
            ...
            if text_color.startswith('#') and check_color.checkColor(drawableNameColor, color1) == 1 and check_color.checkColor(text_color6, color0) != 1:
                if id not in colorToChange:
                    colorToC = find_colorToChange(nonIssueColorAct, id_bound_colorSet, componentClass, id, colorToChange_class)
                    # print colorToChange
...
def changeLayout_decompileAPK(decom_Path, id_bound_colorSet, colorToChange, nonIssueColorAct, colorToChange_class):
    imageId_Name = {}
    editId = []
    id_style = {}
    id_class = {}
                    ...
                    if txt.find(":id=") == -1 and txt.find(":text=") == -1 and txt != "" and txt.find(":title=") == -1:
                        ...
                        if txt.startswith("EditText") or txt0.split(' ')[0].find("EditText") != -1:
                            ...
                            solution = solveTextContrast(decom_Path, id, txt, colorToChange, colorName_colorNew, id_style,
                                                  nonIssueColorAct, id_bound_colorSet, colorToChange_class)
                            txt = solution[0]
                            id_style = solution[1]
    ...
    for id_componentClass in imageId_Name:
        ...
        ##220301
        # if id not in colorToChange:
        #     colorToC = find_colorToChange(nonIssueColorAct, id_bound_colorSet, id_class[id], id, colorToChange_class)
        #     colorToChange[id] = colorToC[id]
        colorToC = find_colorToChange(nonIssueColorAct, id_bound_colorSet, id_class[id], id, colorToChange_class)
...
def changeStyle_decompileAPK(decom_Path, id_style, imageId_style, imageId_Name, id_bound_colorSet, colorToChange, nonIssueColorAct, colorName_colorNew, Manifest, colorToChange_class):
    # colorName_colorNew = {}
                        ...
                        if txt.find("android:textColor") == -1:
                            ...
                            if id_component[0] in colorToChange:
                                ...
                                colorToC = find_colorToChange(nonIssueColorAct, id_bound_colorSet, id_component[1],
                                                              id_component[0], colorToChange_class)
...
def changeImages_decompileAPK(decom_Path, id_bound_colorSet, imageId_NameF):
    imagesToChangeF, imageids = changeImageCondition.changeSourceImage(decom_Path, imageId_NameF, id_bound_colorSet)
...
# ids_location_inOneAPK = get_id_inOneAPK(os.path.join(resultPath, APKName), APKName, outputsPath)
...
# colorToChange_class = {}
#
# editTextId = changeLayout_decompileAPK(os.path.join(HOME_PATH, APKName), id_bound_colorSet, colorToChange, nonIssueColorAct, colorToChange_class)
...
#     print editTextId[3]
#     changeStyle = changeStyle_decompileAPK(os.path.join(HOME_PATH, APKName), editTextId[2], editTextId[5], editTextId[4], id_bound_colorSet, colorToChange, nonIssueColorAct, editTextId[3], Manifest, colorToChange_class)
...
#         for idlo in ids_location_inOneAPK[4]:
#             if imageIdName[0] == idlo[0]:
#                 imageId_NameF[ids_location_inOneAPK[4][idlo]] = (
#                 imageId_Name[imageIdName][0], imageId_Name[imageIdName][1], imageIdName[0], imageIdName[1])
#     else:
#         imageId_NameF[ids_location_inOneAPK[4][imageIdName]] = (imageId_Name[imageIdName][0], imageId_Name[imageIdName][1], imageIdName[0], imageIdName[1])
# print imageId_NameF
#
# imageids = changeImages_decompileAPK(os.path.join(HOME_PATH, APKName), id_bound_colorSet, imageId_NameF)
# print imageids
#
...
#
#
# colorToChange_self = find_colorToChange_self(resultPath, APKName, id_bound_colorSet)[0]
