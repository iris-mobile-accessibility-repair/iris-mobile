...
def de_re_pack(apk_path, apkname, results_folder):
    file_path = ''
    pathDir1 = os.listdir('/home/zyx/Desktop/work/apktool01')
    pathDir2 = os.listdir('/home/zyx/Desktop/work/apktool11')
    pathDir3 = os.listdir('/home/zyx/Desktop/work0/apktool')
    ...
    if id_bound_colorSet != {}:
        ...
        change_color_class.changeImages_decompileAPK(decompilePath, id_bound_colorSet, imageId_NameF)
