...
def changeLayout_decompileAPK(decom_Path, id_bound_colorSet, colorToChange, nonIssueColorAct, colorToChange_class):
    ...
    for id_componentClass in imageId_Name:
        ...
        if id not in colorToChange:
            ...
            colorToChange[id] = colorToC[id]
        imageId_Name[id_componentClass] = (imageId_Name[id_componentClass], colorToChange[id])
    # print "imageId_Name"
    # print imageId_Name
    # print "imageId_style"
    # print imageId_style
...
def changeImages_decompileAPK(decom_Path, id_bound_colorSet, imageId_NameF):
    imagesToChangeF = changeImageCondition.changeSourceImage(decom_Path, imageId_NameF, id_bound_colorSet)
    for imgPath in imagesToChangeF:
        print imgPath
        img = changeImageColor.transparence2white(imgPath, '#505050')
...
# print imageId_NameF
#
# changeImages_decompileAPK(os.path.join(HOME_PATH, APKName), id_bound_colorSet, imageId_NameF)
#
